...
var COLUMNS = [
  { field: 'id', header: 'ID' },
  { field: 'customerName', header: 'Item'},
  { field: 'productCode', header: 'Why you bought it' },
  { field: 'unitsOrdered', header: 'Units Bought' },
            ...
            dataValidation: {
              condition: {
                ...
                values: [
                  ...
                  { userEnteredValue: 'RECREATION' },
                  { userEnteredValue: 'SURVIVAL' }
                ]
              },
              strict: true,
              showCustomUi: true
          ...
          values: [
            {
              pivotTable: {
                ...
                rows: [
                  {
                    sourceColumnOffset: getColumnForField('customerName').index,
                    showTotals: false,
                    sortOrder: 'ASCENDING'
                  }
                ],
